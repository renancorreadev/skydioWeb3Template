[TypeDoc Pages Plugin](../README.md) / [Exports](../modules.md) / WhitelistInterface
...
- [\_abiCoder](WhitelistInterface.md#_abicoder)
- [\_isInterface](WhitelistInterface.md#_isinterface)
- [contractName](WhitelistInterface.md#contractname)
- [deploy](WhitelistInterface.md#deploy)
- [errors](WhitelistInterface.md#errors)
- [events](WhitelistInterface.md#events)
- [fragments](WhitelistInterface.md#fragments)
- [functions](WhitelistInterface.md#functions)
- [structs](WhitelistInterface.md#structs)

### Methods

- [\_decodeParams](WhitelistInterface.md#_decodeparams)
- [\_encodeParams](WhitelistInterface.md#_encodeparams)
- [decodeErrorResult](WhitelistInterface.md#decodeerrorresult)
- [decodeEventLog](WhitelistInterface.md#decodeeventlog)
- [decodeFunctionData](WhitelistInterface.md#decodefunctiondata)
- [decodeFunctionResult](WhitelistInterface.md#decodefunctionresult)
- [encodeDeploy](WhitelistInterface.md#encodedeploy)
- [encodeErrorResult](WhitelistInterface.md#encodeerrorresult)
- [encodeEventLog](WhitelistInterface.md#encodeeventlog)
- [encodeFilterTopics](WhitelistInterface.md#encodefiltertopics)
- [encodeFunctionData](WhitelistInterface.md#encodefunctiondata)
- [encodeFunctionResult](WhitelistInterface.md#encodefunctionresult)
- [format](WhitelistInterface.md#format)
- [getError](WhitelistInterface.md#geterror)
- [getEvent](WhitelistInterface.md#getevent)
- [getEventTopic](WhitelistInterface.md#geteventtopic)
- [getFunction](WhitelistInterface.md#getfunction)
- [getSighash](WhitelistInterface.md#getsighash)
- [parseError](WhitelistInterface.md#parseerror)
- [parseLog](WhitelistInterface.md#parselog)
- [parseTransaction](WhitelistInterface.md#parsetransaction)
...
src/contracts/types/Whitelist.ts:10
...
src/contracts/types/Whitelist.ts:13
...
src/contracts/types/Whitelist.ts:11
